...
<html lang="en">
<head>
  <title>Book Service - User Dashboard</title>
          ...
          <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
              <div class="card-header bg-white border-0">
                <h3 class="mb-0">Book Cleaning Service</h3>
              </div>
              <div class="card-body pb-5">
                <form autocomplete="off" method="POST" action="userhandler.php">
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-6">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-timein">Preferred Time <span class="text-danger">*</span></label>
                          <input name="reqTime" type="time" id="input-timein" class="form-control form-control-alternative" required>
                        </div>
                      </div>
                    </div>
                    <button name="reqSubmit" class="btn btn-icon btn-3 btn-primary" type="submit">Proceed to Payment</button>
                  </div>
                </form>
              </div>
            </div>
